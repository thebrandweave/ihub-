...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
    ...
    <div class="px-4 md:px-8 py-4 md:py-6 border-b border-gray-100 bg-gradient-to-r from-red-50 to-pink-50">
        <h3 class="text-lg md:text-xl font-semibold text-gray-800 flex items-center">
            ...
            <span class="text-sm md:text-base">Customer Account Details</span>
        </h3>
        <p class="text-xs md:text-sm text-gray-600 mt-1 md:ml-13">Fill in the information below to create a new customer account</p>
    </div>
    ...
    <form method="POST" class="p-4 md:p-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs text-gray-500">Enter the customer's complete legal name</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs text-gray-500">This email will be used for login and order notifications</p>
                </div>
            ...
            <!-- Right Column -->
            <div class="space-y-6">
                <h4 class="text-lg font-semibold text-gray-800 pb-3 border-b border-gray-200">Account Type & Permissions</h4>
                ...
                <div class="bg-gradient-to-br from-red-50 to-pink-50 border border-red-200 rounded-xl p-6">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-bold text-gray-800 mb-2">Customer Account</p>
                            <p class="text-xs text-gray-700 leading-relaxed">This account will be created with customer privileges including:</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 space-y-2 ml-16">
                        ...
                        <div class="flex items-center text-xs text-gray-700">
                            ...
                            Contact support and leave reviews
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-purple-50 border border-purple-200 rounded-xl p-6">
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-purple-800 mb-1">Account Activation</p>
                            <p class="text-xs text-purple-700 leading-relaxed">The account will be immediately active after creation. The customer can log in using their email and password to start shopping right away.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-green-50 border border-green-200 rounded-xl p-6">
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-green-800 mb-1">Customer Communication</p>
                            <p class="text-xs text-green-700 leading-relaxed">Consider sending a welcome email with account details and next steps. Make sure to communicate the temporary password securely.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-yellow-800 mb-1">Data Privacy</p>
                            <p class="text-xs text-yellow-700 leading-relaxed">All customer data is stored securely and will be handled according to privacy regulations. Ensure proper consent is obtained.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 mt-6 md:mt-8 pt-6 md:pt-8 border-t border-gray-200">
            ...
            <button type="submit" class="w-full sm:w-auto px-6 md:px-8 py-2.5 md:py-3 text-xs md:text-sm font-medium text-white bg-gradient-to-r from-red-500 to-pink-600 rounded-lg hover:from-red-600 hover:to-pink-700 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center">
                ...
                <span class="hidden sm:inline">Create Customer Account</span>
                <span class="sm:hidden">Create Account</span>
            </button>
        </div>
    </form>
</div>
